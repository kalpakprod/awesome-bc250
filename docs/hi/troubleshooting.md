...
| MangoHud **655 %** GPU usage दिखाता है | amdgpu activity metric को `0xFFFF` पर छोड़ता है; MangoHud 65535/100 पढ़ता है | cyan-skillfish-governor-smu (smu branch) चलाएँ — यह `gpu_metrics` patch करता है; कोई MangoHud बदलाव की ज़रूरत नहीं ([elektricM](https://github.com/elektricM/amd-bc250-docs/blob/main/docs/troubleshooting/performance.md)) → [09 — Overclock](../en/09-overclock-undervolt.md) |
...
| Game **OOM crash / artifacts फिर मर जाता है** (RDR2, CoH3) | **512 MB dynamic VRAM + ZRAM** conflict | BIOS को **fixed VRAM** पर बदलें (जैसे 10 GB RAM / 6 GB VRAM) या ZRAM disable करें ([elektricM](https://github.com/elektricM/amd-bc250-docs/blob/main/docs/troubleshooting/stability.md)) → [08 — BIOS](../en/08-bios.md) |
