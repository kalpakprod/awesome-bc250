...
| Оюн **OOM крэш болот / артефакттар анан өлөт** (RDR2, CoH3) | **512 MB динамикалык VRAM + ZRAM** кагылышы | BIOS'ту **бекитилген VRAM**'ге которуңуз (мис. 10 GB RAM / 6 GB VRAM) же ZRAM'ди өчүрүңүз ([elektricM](https://github.com/elektricM/amd-bc250-docs/blob/main/docs/troubleshooting/stability.md)) → [08 — BIOS](../en/08-bios.md) |
