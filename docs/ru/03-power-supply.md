...
- **Уберите вой вентилятора БП во время сна (обходы от сообщества).** Так как БП продолжает работать, пока плата спит, некоторые **подключают вентилятор БП в разъём вентилятора BC-250** шлейфом, чтобы он сбрасывал обороты вместе с платой, либо ставят **маленький транзистор, чтобы PS_ON следовал за питанием платы**. Считайте это любительскими хаками, а не документированной спецификацией.
