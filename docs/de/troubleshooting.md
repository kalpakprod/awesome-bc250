...
| MangoHud zeigt **655 %** GPU-Auslastung | amdgpu lässt die Aktivitäts-Metrik auf `0xFFFF`; MangoHud liest 65535/100 | cyan-skillfish-governor-smu (smu-Branch) laufen lassen — er patcht `gpu_metrics`; keine MangoHud-Änderung nötig ([elektricM](https://github.com/elektricM/amd-bc250-docs/blob/main/docs/troubleshooting/performance.md)) → [09 — Übertakten](../en/09-overclock-undervolt.md) |
...
| Spiel **stürzt mit OOM ab / Artefakte, dann tot** (RDR2, CoH3) | Konflikt aus **512 MB dynamischem VRAM + ZRAM** | BIOS auf **festen VRAM** umstellen (z. B. 10 GB RAM / 6 GB VRAM) oder ZRAM deaktivieren ([elektricM](https://github.com/elektricM/amd-bc250-docs/blob/main/docs/troubleshooting/stability.md)) → [08 — BIOS](../en/08-bios.md) |
