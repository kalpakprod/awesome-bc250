...
| Гра **вилітає по OOM / артефакти, потім падає** (RDR2, CoH3) | Конфлікт **512 MB dynamic VRAM + ZRAM** | Перемкніть BIOS на **fixed VRAM** (напр. 10 ГБ RAM / 6 ГБ VRAM) або вимкніть ZRAM ([elektricM](https://github.com/elektricM/amd-bc250-docs/blob/main/docs/troubleshooting/stability.md)) → [08 — BIOS](../en/08-bios.md) |
